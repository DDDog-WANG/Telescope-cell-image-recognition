...
PYDIR=$HOMEPATH/Biomarker/featureCAM.py
STAINTYPE=$STAINTYPE
CTRLTYPE=$CTRLTYPE
CAMTYPE=$CAMTYPE
IMAGEPATH=$HOMEPATH/Classification/results_cam
...
echo "#############################"
python $PYDIR --stain_type $STAINTYPE --ctrl_type $CTRLTYPE --cam_type $CAMTYPE --image_path $IMAGEPATH --save_path $SAVEPATH
