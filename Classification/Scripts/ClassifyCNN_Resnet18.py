...
datatype = sys.argv[2]
print("This is Resnet18", flush=True)
...
for num in range(n_splits):
    ...
    savepath = home_path+"/results/resnet18_"+datatype+"/"+name_title+".png"
...
torch.save(model.module.resnet.state_dict(),home_path+"/Models/Resnet18_"+datatype+".pkl")
print("saved model as "+home_path+"/Models/Resnet18_"+datatype+".pkl", flush=True)
print("done", flush=True)