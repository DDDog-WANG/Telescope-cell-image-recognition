...
datatype = sys.argv[2]
print("This is Resnet10", flush=True)
print(datatype, flush=True)
# 1. Load and Process Images
print("1. Load and Process Images", flush=True)
X_Ctrl = np.load(home_path+"/Datasets/Ctrl_"+datatype+".npy",allow_pickle=True)
X_VPA = np.load(home_path+"/Datasets/VPA_"+datatype+".npy",allow_pickle=True)
...
for num in range(n_splits):
    ...
    savepath = home_path+"/results/resnet10_"+datatype+"/"+name_title+".png"
...
torch.save(model.module.resnet.state_dict(),home_path+"/Models/Resnet10_"+datatype+".pkl")
print("saved model as "+home_path+"/Models/Resnet10_"+datatype+".pkl", flush=True)
print("done", flush=True)